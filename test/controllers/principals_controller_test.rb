...
class PrincipalsControllerTest < ActionController::TestCase
  ...
  test "should create principal" do
    assert_difference('Principal.count') do
      post :create, principal: { academico: @principal.academico, apellido: @principal.apellido, nombre: @principal.nombre }
    end
  ...
  test "should update principal" do
    patch :update, id: @principal, principal: { academico: @principal.academico, apellido: @principal.apellido, nombre: @principal.nombre }
    assert_redirected_to principal_path(assigns(:principal))
  end
