...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { calendar_id: @professor.calendar_id, career_id: @professor.career_id, teacher_id: @professor.teacher_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { calendar_id: @professor.calendar_id, career_id: @professor.career_id, teacher_id: @professor.teacher_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
