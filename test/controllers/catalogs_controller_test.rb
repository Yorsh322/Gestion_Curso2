...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { group_id: @catalog.group_id, professor_id: @catalog.professor_id, semester_id: @catalog.semester_id, subject_id: @catalog.subject_id }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { group_id: @catalog.group_id, professor_id: @catalog.professor_id, semester_id: @catalog.semester_id, subject_id: @catalog.subject_id }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
