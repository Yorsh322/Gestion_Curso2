...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { calendar_id: @semester.calendar_id, current: @semester.current, grado: @semester.grado }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { calendar_id: @semester.calendar_id, current: @semester.current, grado: @semester.grado }
    assert_redirected_to semester_path(assigns(:semester))
  end
